      ...
      <BrowserRouter>
        <Routes>
          ...
          >
            ...
            {/* Device Measurements */}
            <Route path="measured-equipments" element={<MeasuredEquipments />} />
            <Route path="measurements/forms" element={<MeasurementForms />} />
            <Route path="measurements/records" element={<MeasurementRecords />} />
